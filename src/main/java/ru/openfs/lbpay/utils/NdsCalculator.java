...
public class NdsCalculator {
    ...
    private static final long NDS_7_NUMERATOR = 7;
    private static final long NDS_7_DENOMINATOR = 107;
    ...
    public static int extractNDS7(int price) {
        return (int) ((price * NDS_7_NUMERATOR + NDS_7_DENOMINATOR / 2) / NDS_7_DENOMINATOR);
    }
